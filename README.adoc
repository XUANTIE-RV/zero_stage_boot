...
Note that for some CPUs using `perf record` need to add the following two lines in `riscv,event-to-mhpmcounters`.
...
perf.data  trace.dat
 ...
 Performance counter stats for 'ls':
              ...
              6.25 msec task-clock                #    0.512 CPUs utilized
                 6      context-switches          #    0.960 K/sec
                 0      cpu-migrations            #    0.000 K/sec
                53      page-faults               #    0.008 M/sec
           4380379      cycles                    #    0.701 GHz
           1130584      instructions              #    0.26  insn per cycle
            141646      branches                  #   22.667 M/sec
             18992      branch-misses             #   13.41% of all branches
            297588      L1-dcache-loads           #   47.622 M/sec
              8485      L1-dcache-load-misses     #    2.85% of all L1-dcache accesses
        2155905152      LLC-loads                 # 344999.969 M/sec
             11579      LLC-load-misses           #    0.00% of all LL-cache accesses
   ...
   <not supported>      L1-dcache-prefetch-misses
       ...
       0.012213926 seconds time elapsed

       0.005146000 seconds user
       0.005146000 seconds sys
....

....
# echo 1000 > /proc/sys/kernel/perf_event_max_sample_rate
# perf record -g ls
perf.data  perf.data.old  trace.dat
